...
class TrimmerView: AVAssetTimeSelector {
    ...
    var mainColor: UIColor = UIColor.orange {
        didSet {
            updateMainColor()
        }
    }
    ...
    var handleColor: UIColor = UIColor.gray {
        didSet {
           updateHandleColor()
        }
    }
    ...
    var positionBarColor: UIColor = UIColor.white {
        didSet {
