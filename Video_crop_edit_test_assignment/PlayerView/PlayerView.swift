...
class PlayerView: UIView {
    ...
    init(url: URL) {
        ...
        let bg = UIColor(red: 16/255, green: 16/255, blue: 16/255, alpha: 1.0)
        backgroundColor = bg
        setPlayer(url)
    }
    ...
    private func setupCropView() {
        ...
        widthHeightXYConstraints = [cropViewWidthAnchor, cropViewHeightAnchor, cropViewCenterXConstraint, cropViewCenterYConstraint]
        topBottomLeftRightConstraints = [cropViewTopAnchor, cropViewBottomAnchor, cropViewLeftAnchor, cropViewRightAnchor]
