...
class ControlPanel: NSObject, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private lazy var colletionView: UICollectionView = {
        ...
        colletionView.register(RatioCollectionViewCell.self,
                               forCellWithReuseIdentifier: RatioCollectionViewCell.identifier)
    ...
    init(videoCropVC: VideoCropViewController) {
        ...
        colletionView.selectItem(at: IndexPath(item: 0, section: 0),
                                 animated: true,
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RatioCollectionViewCell.identifier,
                                                            for: indexPath) as? RatioCollectionViewCell else {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RatioCollectionViewCell.identifier,
                                                            for: indexPath) as? RatioCollectionViewCell else { return }
