...
class RatioCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        imageView.frame = CGRect(x: imageMargin,
                                 y: imageMargin,
                                 width: contentView.frame.width-2*imageMargin,
                                 height: contentView.frame.width-2*imageMargin)
        label.frame = CGRect(x: labelMargin,
                             y: imageView.frame.maxY+labelMargin,
                             width: contentView.frame.width-2*labelMargin,
                             height: contentView.frame.height-contentView.frame.width-2*labelMargin)
    }
